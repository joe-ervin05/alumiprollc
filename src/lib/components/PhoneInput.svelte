...
<div class="flex relative rounded-lg {valid ? `` : ``}">
			...
			>
				...
				>
					<input
						...
						type="text"
						class="px-4 py-2 text-gray-900 focus:outline-none w-full sticky top-0 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400dark:shadow-sm-light"
	...
	<input
		type="text"
		class="hidden"
		bind:value={selectedCountryDialCode}
		name="dialCode"
		id="dialCode"
	/>
	<input type="text" class="hidden" bind:value={selectedCountry} name="country" id="country" />
	<TelInput
		id="tel-input"
		name="phone"
		...
		{options}
		{required}
		class="text-sm rounded-r-lg block w-full p-3 border border-gray-200 border-l-gray-100 dark:border-l-gray-700 dark:border-gray-600 dark:bg-gray-700 
        dark:placeholder-gray-400 dark:text-white text-gray-900 focus:ring-primary-500 focus:border-primary-500 dark:focus:ring-primary-500
